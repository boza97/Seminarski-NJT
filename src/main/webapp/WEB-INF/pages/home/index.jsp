...
<div class="slider-wrapper theme-default">
    <div id="slider" class="nivoSlider">
        <img src="${root}/resources/img/slide1.png" data-thumb="resources/img/slide1.png">
        <img src="${root}/resources/img/slide2.jpg" data-thumb="resources/img/slide2.jng">
        <img src="${root}/resources/img/slide3.jpg" data-thumb="resources/img/slide3.jpg">
        <img src="${root}/resources/img/slide4.jpg" data-thumb="resources/img/slide4.jpg">
    </div>
</div>
